    ...
    private void SetPagePositions() {
        ...
        for (int i = 0; i < _pageCount; i++) {
            ...
            if (_horizontal) {
                ...
                child.anchorMin = new Vector2(width / _container.rect.width * i, 0f);
                child.anchorMax = new Vector2(child.anchorMin.x + width / _container.rect.width, 1f);
            }
            else {
                childPosition = new Vector2(0f, -(i * height - containerHeight / 2 ));
            }
